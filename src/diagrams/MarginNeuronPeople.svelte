<script>
    ...
    let neurons = [
      {
        neuron: {model: "4x", unit: "1777", layer: "image_block_4_5_Add_6_0"},
        facet: "face",
        ds_img_prefix: "images/neuron-examples/jesus-",
        description: 'Jesus',
        strength: 8
      },
      {
        neuron: {model: "4x", unit: "309", layer: "image_block_4_5_Add_6_0"},
        facet: "face",
        ds_img_prefix: "images/neuron-examples/hitler-",
        description: 'Hitler',
        strength: 5
      },
    ];
