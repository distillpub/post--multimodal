...
<div style="display: flex; flex-direction: row; border-radius: 6px; overflow: hidden; width: fit-content; width: min-content; height: {calculateImageSize()}px; border: 1px solid {calculateBorderColor()};">
