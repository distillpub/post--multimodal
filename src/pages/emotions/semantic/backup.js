    ...
    <Surface width={1200} margin="auto">
      {emotionNames.map((name) => (
        <Surface marginX={10} flexFlow="row" alignItems="center" marginY={20}>
          ...
          <div fontSize={24} opacity={0.6} marginLeft={20}>
            =
          </div>
                  ...
                  <Surface flexFlow="row" alignItems="center" marginX={20}>
                    <Surface height={100}>
                      ...
                      <Surface height={20}>
                        ...
                        >
                          <a
                            href={`http://microscope.openai.com/models/contrastive_4x/image_block_4_5_Add_6_0/${neuron}`}
                            style={{ textDecoration: 'none', color: '#333' }}
                            target="_blank"
                          >
                            {(neuronNames[neuron] || neuron).toString()}
                          </a>
                        </div>
                      </Surface>
                    </Surface>
